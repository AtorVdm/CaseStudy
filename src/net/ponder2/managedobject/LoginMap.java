 ...
 * @version $Id:$
 */
public class LoginMap implements ManagedObject {
  ...
  P2Object p2_operation_at(String name) {
    ...
    /**
     * checks existence of the object by name
     *
     * @param name
     *          the name of the object to be found
     * @return the named object
     */
  @Ponder2op("has:")
  boolean p2_operation_has(String name) { return data.containsKey(name); }
   ...
   */
  @Ponder2op("size")
  int p2_operation_size() { return data.size(); }
}
